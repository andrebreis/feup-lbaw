				...
				<section class="content">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<div class="col-md-12">
									<button id="create-task" type="button" class="btn btn-success col-md-offset-10 col-md-2 pull-right">Create Milestone</button>
								</div>
												...
												<td>
													<div class="media">
														<div class="media-body">
															...
															<div class="progress">
																<span class="progress-value">0% - Pending Development</span>
