...
<head>
    ...
    <link href="../css/landing_modal.css" rel="stylesheet">
...
<div class="container">
    ...
    <div id="login">
        <button id="sign" type="button" class="btn btn-default" data-toggle="modal" data-target="#login-modal">Sign In/Up</button>
    </div>
