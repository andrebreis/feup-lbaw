        ...
        <div class="col-md-9">
            ...
            <div class="project-content">
                <div class="row forum_header">
                    <div class="title col-md-4 col-xs-9">
                    ...
                    <div class="col-md-2 col-xs-4">
                        <button id="new_post_btn" type="button" class="btn btn-default newPost" data-toggle="modal" data-target="#createPostModal">Create Post</button>
                    </div>
                </div>
