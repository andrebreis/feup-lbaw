                    ...
                    <form id="register-form" style="display:none;">
                        <div class="modal-body">
                            ...
                            <input id="register_password" name="password" class="form-control" type="password"
                                   ...
                                   required>
                            <input id="register_password_repeat" name="password-repeat" class="form-control"
                                   type="password"
                                   placeholder="Repeat Password"
                                   required>

                            <button type="submit" class="btn btn-lg btn-block" style="margin-top:0.5em;">Register
                            </button>
                    ...
                    <li>
                        {if isset($USERNAME)}
                            <form id="logout_form" action="../actions/logout.php">
                                <button id="logout" class="btn btn-link btn-sm" type="submit"><i class="fa fa-sign-out"
                                                                                                 aria-hidden="true"></i>
                                    Logout
                                </button>
                            </form>
                        {else}
                            <a id="signinup" href="#signinup" data-toggle="modal" data-target="#login-modal">Sign
                                In/Up</a>
                        {/if}
                    </li>
                </ul>
