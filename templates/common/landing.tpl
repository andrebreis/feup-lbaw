...
<head>
    ...
    <meta name="google-signin-client_id"
          content="769099850836-5hhqtsupulh8psji8fijuqltepntkjhq.apps.googleusercontent.com">
                ...
                <div id="div-forms">
                    ...
                    <form id="login-form" action="../actions/login.php" method="post">
                        ...
                        <div class="modal-footer">
                            <div>
                                <button id="login-btn" type="submit" value="submit" class="btn btn-lg btn-block">Login
                                </button>
                            </div>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <h3>Project Roles</h3>
                    <p id="text" class="text-muted">You can set your team leaders as project coordinators, so they help
                        you
            ...
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <p id="text" class="text-muted">Our platform lets you define milestones so you can split your
                        projects in
                        smaller parts.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <h3>Project Tasks</h3>
                    <p id="text" class="text-muted">You can assign tasks to your coworkers so they always know what's
                        left for
                        them to do!</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <h3>Project Forum</h3>
                    <p id="text" class="text-muted">Everyone deserves a word, so everyone can discuss about the project
                        on your
                        project forum.</p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                ...
                <hr class="primary">
                <p id="text">Got any idea to help us improve our platform? That's great! That's great! Give us a call or
                    send us
